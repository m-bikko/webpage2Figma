...
var H2DSerializer = (() => {
  ...
  var reportGaps = (el, cs, sink, id) => {
    ...
    if (cs.maskImage !== "none" && cs.maskImage !== "") {
      sink.report(
        "warning",
        DIAGNOSTIC_CODES.deferredMask,
        `mask-image "${cs.maskImage.slice(0, 60)}" \u043D\u0435 \u043F\u0435\u0440\u0435\u043D\u043E\u0441\u0438\u0442\u0441\u044F: \u0443\u0437\u0435\u043B \u043F\u0440\u0438\u0435\u0434\u0435\u0442 \u0446\u0435\u043B\u044B\u043C, \u0431\u0435\u0437 \u0432\u044B\u0440\u0435\u0437\u0430\u043D\u043D\u043E\u0439 \u043C\u0430\u0441\u043A\u043E\u0439 \u0447\u0430\u0441\u0442\u0438.`,
        id,
        false
      );
    }
    if (cs.borderImageSource !== "none" && cs.borderImageSource !== "") {
      sink.report(
        "warning",
        DIAGNOSTIC_CODES.deferredMask,
        `border-image "${cs.borderImageSource.slice(0, 60)}" \u043D\u0435 \u043F\u0435\u0440\u0435\u043D\u043E\u0441\u0438\u0442\u0441\u044F: \u0440\u0430\u043C\u043A\u0430 \u043F\u0440\u0438\u0435\u0434\u0435\u0442 \u043E\u0431\u044B\u0447\u043D\u043E\u0439 \u0441\u043F\u043B\u043E\u0448\u043D\u043E\u0439 \u0438\u043B\u0438 \u043D\u0435 \u043F\u0440\u0438\u0435\u0434\u0435\u0442 \u0432\u043E\u0432\u0441\u0435.`,
        id,
        false
      );
    }
