 ...
 *  при пустом отчёте.
 *
 *  ВНИМАНИЕ: блок ограничен планом 1 и удаляется ПО ФИЧЕ по мере их
 *  реализации в плане 2. Реализовали transform — убрали проверку
 *  transform, и так далее. Если этого не делать, блок превратится в
 *  окаменелость и начнёт отвергать КОРРЕКТНЫЕ бандлы, в которых фича
 *  работает и диагностировать её больше не нужно. */
